module Elm.Review.Reporter exposing
    ...
    , formatFixProposals
    , FileWithError, Options, Range, compareRange, formatConfigurationErrors, formatSingleFixProposal
    )
...
reasonFromProblem : FixOptions.Explanation -> FixProblem -> List Text
