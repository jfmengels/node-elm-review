      ...
      , display =
            Just
                (\_ ->
                    ...
                    , sections = [ "regular" ]
                    , description =
                        [ "Re-run ${GreenBright('elm-review" ++ " automatically when your project or configuration"
                        , "changes. Use ${Cyan('--watch-code" ++ " to re-run only on project changes."
                        , "You can use ${Cyan('--watch" ++ " and ${BlueBright('--fix" ++ " together."
                        ]
                    , initDescription = Nothing
                    , newPackageDescription = Nothing
                    }
                ...
                (\c ->
                    ...
                    , initDescription =
                        Just
                            ...
                            , "down in the ${Yellow('review/elm.json" ++ " file’s \"elm-version\" field. Use this if you"
      ...
      , display =
            Just
                (\_ ->
                    ...
                    , sections = [ "regular" ]
                    , description =
                        [ "Print the version of the ${GreenBright('elm-review" ++ " CLI."
                        ]
                    , initDescription = Nothing
                    , newPackageDescription = Nothing
                    }
            ...
            Just
                (\_ ->
                    ...
                    , description =
                        ...
                        , "This will also run the compiler with ${Cyan('--debug" ++ ", allowing you to use"
                        , "${Yellow('Debug" ++ " functions in your custom rules."
                        ]
                    , initDescription = Nothing
                    , newPackageDescription = Nothing
                    }
            ...
            Just
                (\c ->
                    ...
                    , description =
                        ...
                        , "if it was called without ${BlueBright('--fix" ++ "."
      ...
      , display =
            Just
                (\c ->
                    ...
                    , sections = [ "fix" ]
                    , description =
                        [ "${GreenBright('elm-review" ++ " will present a single fix containing the application of all"
            ...
            Just
                (\_ ->
                    ...
                    , description =
                        ...
                        , "updated when running ${GreenBright('elm-review" ++ ", which people can forget to commit"
