 ...
 * @typedef { import("./types/flag").BaseFlag } BaseFlag
 * @typedef { import("./types/flag").DisplayableFlag } DisplayableFlag
 * @typedef { import("./types/flag").Single } Single
 * @typedef { import("./types/flag").SingleOrMulti } SingleOrMulti
 * @typedef { import("./types/flag").Section } Section
...
/**
 * @type {BaseFlag & Single & DisplayableFlag}
 */
const reportFlag = {
  name: 'report',
  boolean: false,
