...
const flags = [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      `I recommend to only use this temporarily, and run ${chalk.green('elm-review init')} with`,
  ...
  },
  {
    ...
    initDescription: [
      ...
      `down in the ${chalk.green('review/elm.json')} file’s \`elm-version\` field. Use this if you`,
