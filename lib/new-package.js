...
`
  ...
  await Init.create(
    ...
    [
      'jfmengels/elm-review-unused@1',
      'jfmengels/elm-review-common@1',
      'jfmengels/elm-review-debug@1',
      'jfmengels/elm-review-documentation@1',
...
function elmJson(authorName, packageName, ruleName, license) {
  return {
    ...
    dependencies: {
      ...
      // TODO Bump to minimal supported version
...
function packageJson(options) {
  return {
    scripts: {
      ...
      'package-tests':
        'node elm-review-package-tests/check-previews-compile.js',
      review: 'elm-review',
