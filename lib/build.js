...
function compilationError(options, stderr) {
  ...
  if (stderr.includes('MODULE NOT FOUND')) {
    return {
      ...
      message: `A module is missing in your configuration`,
      /* eslint-disable prettier/prettier */
      message2: [
        `A module is missing in your configuration. Maybe you forgot to add some dependencies that contain the rules you wished to enable? If so, run ${chalk.cyanBright('elm install')} with the package name from inside ${chalk.yellowBright(options.userSrc(null))}.`
      ]
      /* eslint-enable prettier/prettier */
    };
  }
