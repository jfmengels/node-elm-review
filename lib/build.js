...
async function build(args, packageJson) {
  ...
  await compileElmProject(args, dest, binary);
  ...
  // $FlowFixMe
  return require(path.join(dest, './main'));
}
...
function compileElmProject(args, dest, binary) {
