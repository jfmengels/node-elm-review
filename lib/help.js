...
function review(options) {
  ...
  console.log(`You are using ${chalk.greenBright(`elm-review ${Anonymize.version(options)}`)}.
    ...
    ${chalk.green('elm-review init')}
        Creates an empty review configuration. It creates a ${chalk.green('review/elm.json')} and
    ...
    ${chalk.green('elm-review suppress')}
    ...
    ${chalk.green('elm-review new-package')}
        Creates an new project aimed to contain rules and to be published later.

    ${chalk.green('elm-review new-rule [RULE-NAME]')}
...
function suppress() {
  ...
  /* eslint-disable prettier/prettier */
  console.log(`The suppress command helps with fixing reported errors gradually.
...
function init() {
  ...
  console.log(`The init command helps getting started with ${chalk.greenBright('elm-review')}’s configuration.
    ...
    ${chalk.magenta('elm-review init')}
        ...
        - ${chalk.green('review/elm.json')} in which you may add dependencies with review rules.
