  ...
  '*no subcommand*': [
    {
      ...
      description: `Specify the path to the ${chalk.magentaBright('elm')} compiler.`
    ...
    },
    {
      ...
      exampleArg: 'review/',
      color: chalk.cyan,
      description: `Use the review configuration in the specified directory instead of the
    ...
    },
    {
      ...
      color: chalk.cyan,
      description: `Run with a subsection of the rules in the configuration. Specify them
