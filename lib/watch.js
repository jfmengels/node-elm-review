...
function createFileWatcher(
  ...
  return chokidar
    ...
    .on('add', async (absolutePath) => {
      ...
      Debug.log(`File ${relativePath} has been added`, options.debug);
    ...
    .on('change', async (absolutePath) => {
      ...
      if (hasChanged) {
        Debug.log(`File ${relativePath} has been changed`, options.debug);
    ...
    .on('unlink', (absolutePath) => {
      ...
      Debug.log(`File ${relativePath} has been removed`, options.debug);
...
function createExtraFilesWatcher(options, app, runReview, onError, request) {
  return chokidar
    ...
    .on('add', async (absolutePath) => {
      ...
      const newSource = await FS.readFile(relativePath);
      Debug.log(`Extra file ${relativePath} has been added`, options.debug);
    ...
    .on('change', async (absolutePath) => {
      ...
      const newSource = await FS.readFile(relativePath);
      Debug.log(`Extra file ${relativePath} has been changed`, options.debug);
    ...
    .on('unlink', (absolutePath) => {
      ...
      Debug.log(`Extra file ${relativePath} has been removed`, options.debug);
