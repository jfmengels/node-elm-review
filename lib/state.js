...
function update(message) {
  switch (message[type]) {
    ...
    case 'foundCommitForTemplate': {
      model.commitForTemplate = message.commit;
      return model;
    }
...
function commitForTemplate() {
  return model.commitForTemplate;
}
...
function foundCommitForTemplate(commit /* : string */) {
  return update({
    [type]: 'foundCommitForTemplate',
    commit
  });
}
