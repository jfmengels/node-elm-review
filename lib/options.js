...
function compute(processArgv /* : Array<string> */) {
  ...
  nonBooleanFlags.forEach((flag) => {
    if (typeof args[flag.command] === 'boolean') {
      const errorToReport = new ErrorMessage.CustomError(
        /* eslint-disable prettier/prettier */
          'INVALID ARGUMENT',
          `The ${chalk.redBright(`--${flag.command}`)} flag needs more information.

It needs ${flag.whatItNeeds} like: ${chalk.greenBright(`--${flag.command} ${flag.exampleArg}`)}`
