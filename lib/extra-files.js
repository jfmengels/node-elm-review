 ...
 * @param {{ files : { pattern: string, included: boolean }[], excludedDirectories: string[] }[]} requests
...
/** .
 * @param {any} globby
 * @param {{ files : { pattern: string, included: boolean }[], excludedDirectories: string[] }} request
 * @returns {Promise<ExtraFile[]>}
 */
