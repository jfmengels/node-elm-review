...
const description = `install # Install a package which contains rules and add it to your "test-dependencies"`;

function installDependency(pathToElmBinary /*: string */, packageName /*: string */) {
  let oldSourceDirectories;
  let dirPath;
